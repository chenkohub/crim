...
(function() {
  ...
  // Resolve a relative URL to an absolute path for comparison
  ...
  function isActive(itemPath) {
    var cur = currentPage();
    var full = resolveUrl(basePath() + itemPath);
  ...
  function isHome() {
    ...
    var home = resolveUrl(basePath() + 'index.html').replace(/\/index\.html$/, '/').replace(/\/$/, '');
    return cur === home;
  }
